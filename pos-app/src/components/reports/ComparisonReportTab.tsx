                    ...
                    <Table className="zebra-rows">
                        <TableHeader className="bg-muted/50 sticky top-0 z-10 backdrop-blur-sm">
                            <TableRow className="border-b border-border">
                                <TableHead className="font-black text-[10px] uppercase tracking-widest py-4 text-muted-foreground">METRIK</TableHead>
                                <TableHead className="text-right font-black text-[10px] uppercase tracking-widest py-4 text-muted-foreground">{labelA}</TableHead>
                                <TableHead className="text-right font-black text-[10px] uppercase tracking-widest py-4 text-muted-foreground">{labelB}</TableHead>
                                <TableHead className="text-center font-black text-[10px] uppercase tracking-widest py-4 text-muted-foreground">PERUBAHAN</TableHead>
                            </TableRow>
                        </TableHeader>
                        <TableBody>
...
function ComparisonRow({ label, valA, valB, delta }: any) {
    const isUp = delta >= 0;
    return (
        <TableRow className="h-14 border-b border-border hover:bg-muted/30 transition-colors">
            ...
            <TableCell className="text-center">
                <Badge className={cn(
                    ...
                    isUp ? "bg-green-100/50 text-green-800 dark:bg-green-900/40 dark:text-green-400 shadow-none hover:bg-green-100/60" : "bg-red-100/50 text-red-800 dark:bg-red-900/40 dark:text-red-400 shadow-none hover:bg-red-100/60"
                )}>
