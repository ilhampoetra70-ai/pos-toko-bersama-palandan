...
import { TrendingUp, Package, BarChart3, Activity } from 'lucide-react';
    ...
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                <StatCard title="Total Pendapatan" value={formatCurrency(data.totals.revenue)} icon={TrendingUp} color="blue" />
                <StatCard title="Total Modal" value={formatCurrency(data.totals.cost)} icon={Package} color="orange" />
                <StatCard title="Laba Kotor" value={formatCurrency(data.totals.profit)} icon={BarChart3} color="green" />
